    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand Column */}
          <div>
            <h3 className="text-xl font-bold mb-4">PartnerPulse</h3>
            <p className="text-purple-200 text-sm mb-4">
              Revolutionizing social advertising through authentic engagement and data-driven results.
            </p>
            {/* Social Icons */}
        ...
        <div className="border-t border-purple-600 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-purple-200">
            © {new Date().getFullYear()} PartnerPulse. All rights reserved.
          </p>
